...
public class Test09 {
	...
	public Test09() {
		//스트림 준비
		FileOutputStream fout = null;//기본
		DataOutputStream dout = null;//보조
		...
		try {
			...
			//DataInput/OutputStream의 장점 : 자바의 데이터를 변환없이 사용할 수 있다
